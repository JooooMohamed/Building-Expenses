...
const categories = [
  { key: "fixed", label: "Fixed / Recurring", icon: "calendar-check", color: colors.fixed },
  { key: "maintenance", label: "Maintenance", icon: "wrench", color: colors.maintenance },
  { key: "elevator", label: "Elevator", icon: "elevator-passenger", color: colors.elevator },
  { key: "project", label: "Project", icon: "hammer", color: colors.project },
  { key: "emergency", label: "Emergency", icon: "alert-circle", color: colors.emergency },
];
      ...
      <View style={styles.field}>
        ...
        <View style={styles.categoryGrid}>
          {categories.map((cat) => (
            ...
            >
              <Icon name={cat.icon} size={16} color={category === cat.key ? cat.color : colors.textTertiary} />
              <Text
                style={[
